...
from src.scheduler.email_templates import (
    get_email_template_verify,
    get_email_template_notify,
    get_email_template_ics,
)
...
@celery_app.task
def send_email_verify(username: str, user_email: str, token: str, subject: str) -> None:
...
@celery_app.task
def send_ics_file(
    username: str, user_email: str, subject: str, game_details: dict
) -> None:
